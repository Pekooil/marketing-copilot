...
export type RefreshConnectorAction = (input: z.input<typeof refreshConnectorInputSchema>) => Promise<{ ok: true; connectorState: ConnectorWorkspaceState; metricsState: MetricsWorkspaceState; message: string } | { ok: false; connectorState?: ConnectorWorkspaceState; message: string }>;
