...
import { storeConnectorSecret } from "@/connectors/worker-db";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    await storeConnectorSecret(config.databaseUrl, { workspaceId: stored.workspaceId, connectionId: stored.connectionId, actorId: identity.userId, tokenSet: tokens });
